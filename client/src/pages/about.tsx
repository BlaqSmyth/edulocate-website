...
export default function About() {
  return (
    <>
      <title>About Us - StudyPlug</title>
      <meta name="description" content="Learn about StudyPlug's 12+ years of experience helping international students achieve their educational dreams with expert guidance and support." />
